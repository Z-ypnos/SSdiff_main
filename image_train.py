...
if __name__ == "__main__":
    # parser, create_model_and_diffusion=create_gaussian_diffusion(model=create_model:Unet), create_named_schedule_sampler -> TrainLoop (init model) -> run_loop
    # train_util.py: self.run_step -> self.forward_backward -> batch+sample -> self.diffusion.training_losses(batch, model, cond)
    # gaussian_diffusion: q_sample, -> model(batch, cond)
